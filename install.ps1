...
param (
    ...
    [string]$ArtifactDownloadUrl = 'https://github.com/astral-sh/uv/releases/download/0.8.17',
...
if ($env:UV_DOWNLOAD_URL) {
  ...
  $ArtifactDownloadUrl = "$installer_base_url/astral-sh/uv/releases/download/0.8.17"
}
